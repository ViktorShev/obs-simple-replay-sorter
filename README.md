...
- **Substring match, not exact match** — your search text just needs to appear *somewhere* in the detected executable name, meaning it doesn't need to match the whole thing. This is what allows `valorant` to match a name like `valorant-shipping64_final`.
